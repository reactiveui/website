...
namespace reactiveui.net.ViewModels
{
    public class MeetupViewModel
    {
        ...
        private static readonly string _googleCalendarText = UrlEncoder.Default.Encode("ReactiveUI Community Meetup");
        private static readonly string _googleCalendarLocation = UrlEncoder.Default.Encode("https://reactiveui.net/");
