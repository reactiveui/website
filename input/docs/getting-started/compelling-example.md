...
Let's now create a `NugetDetailsViewModel.cs` class that will wrap our NuGet metadata into a more usable class for our View. It includes a [ReactiveCommand](https://reactiveui.net/docs/handbook/commands) for opening the NuGet Repository URL.
