...
NameDescription![Public property](https://reactiveui.net/assets/img/Hh211972.pubproperty(en-us,VS.103).gif "Public property")[Control](Control\ControlScheduler.Control.md)Gets the control associated with the ControlScheduler.![Public property](https://reactiveui.net/assets/img/Hh211972.pubproperty(en-us,VS.103).gif "Public property")[Now](Now\ControlScheduler.Now.md)Gets the scheduler's notion of current time.Top
