...
NameDescription![Public property](https://reactiveui.net/assets/img/Hh211972.pubproperty(en-us,VS.103).gif "Public property")[Now](Now\CurrentThreadScheduler.Now.md)Gets the scheduler's notion of current time.![Public property](https://reactiveui.net/assets/img/Hh211972.pubproperty(en-us,VS.103).gif "Public property")[ScheduleRequired](ScheduleRequired\CurrentThreadScheduler.ScheduleRequired.md)Gets a value indicating whether the caller must call a schedule method.Top
