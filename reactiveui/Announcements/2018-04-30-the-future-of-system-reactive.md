...
We are centralising everything to-do with System.Reactive on the ReactiveUI brand as it has the most vibrant, active community and the maintainers have the most skin the game. Please join the conversation over at [ReactiveUI Slack Channel](https://join.slack.com/t/reactivex/shared_invite/zt-lt48skpz-G5WDYOAuzA80_MByZrLT0g) in #rxnet and please consider [financially supporting the community](./support) or If you can't (or won't) help out financially, then please donate your time.
