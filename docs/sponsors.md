...
These companies support ReactiveUI and the people who maintain it.

<div class="grid cards" markdown>

-   [![JetBrains](images/sponsors/jetbrains.svg)](https://www.jetbrains.com/)
...
-   [![OpenAI](images/sponsors/openai.svg)](https://openai.com/codex/)
    ...
    [OpenAI](https://openai.com/) supports the maintainers with [Codex](https://openai.com/codex/)
