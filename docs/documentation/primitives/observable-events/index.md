...
subscription to its disposables with `DisposeWith`. See [WhenActivated](../../reactiveui/handbook/when-activated.md).
...
See the [operator pages](../index.md#the-operator-pages) and [events](../../reactiveui/handbook/events.md) for more.
...
- [Events](../../reactiveui/handbook/events.md)
