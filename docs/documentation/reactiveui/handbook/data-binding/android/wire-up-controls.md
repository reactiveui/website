...
NoTitle: true
---
Since .NET for Android doesn't provide a built-in way to automatically generate properties for subviews in your layout, ReactiveUI provides a helper method to do this for you.
