...
> **Note** If you are willing to use your own DI container, see [Override Default Depenedency Inversion Container](custom-dependency-inversion.md). [Splat](https://github.com/reactiveui/splat#dependency-resolver-packages) includes dependency resolver packages for `Autofac`, `DryIoc`, `Microsoft.Extensions.DependencyInjection`, `Ninject`, and `SimpleInjector`.
