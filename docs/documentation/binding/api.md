...
| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `sealed class ObservableAsPropertyAttribute : Attribute` | Marks a partial, get-only property as backed by an [`ObservableAsPropertyHelper<T>`](properties.md). The source generator writes the property's body and a helper field named `_{name}Helper`, which you assign with `ToProperty`. | None. | — |
...
| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `sealed class ObservableAsPropertyHelper<T>` | Backs a read-only "output property" with an observable. The property reports each new value through the change callbacks it was created with, so the owning object can raise its own change notifications. | `T`: The type of the property value | — |

**Constructors**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, T? initialValue)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with an initial value. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; `T?` `initialValue`: The value the property holds before the source produces one | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, Func<T?>? getInitialValue)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback and an initial value factory. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; [`Func<T?>?`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the source produces one; null returns the default value | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, T? initialValue)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback and an initial value. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; `T?` `initialValue`: The value the property holds before the source produces one | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Func<T?> getInitialValue, bool deferSubscription)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with an initial value factory and deferred subscription. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Func<T?>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the source produces one; null returns the default value; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, T? initialValue, ISequencer? scheduler)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with an initial value and a scheduler. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; `T?` `initialValue`: The value the property holds before the source produces one; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, T? initialValue, bool deferSubscription)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with an initial value and deferred subscription. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; `T?` `initialValue`: The value the property holds before the source produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, Func<T?>? getInitialValue, bool deferSubscription)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback, an initial value factory and deferred subscription. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; [`Func<T?>?`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the source produces one; null returns the default value; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, T? initialValue, bool deferSubscription)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback, an initial value and deferred subscription. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; `T?` `initialValue`: The value the property holds before the source produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, T? initialValue, bool deferSubscription, ISequencer? scheduler)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with an initial value, deferred subscription and a scheduler. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; `T?` `initialValue`: The value the property holds before the source produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, Func<T?>? getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback, an initial value factory, deferred subscription and a scheduler. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; [`Func<T?>?`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the source produces one; null returns the default value; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | — |
| `ObservableAsPropertyHelper(IObservable<T?> observable, Action<T?> onChanged, Action<T?>? onChanging, T? initialValue, bool deferSubscription, ISequencer? scheduler)` | Initializes a new instance of the [`ObservableAsPropertyHelper<T>`](properties.md) class with a changing callback, an initial value, deferred subscription and a scheduler. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`Action<T?>`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanged`: The callback run after each new value is stored; [`Action<T?>?`](https://learn.microsoft.com/dotnet/api/system.action-1) `onChanging`: The callback run before each new value is stored, or null for none; `T?` `initialValue`: The value the property holds before the source produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | — |

**Methods**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `static Create(IObservable<T?> observable, object owner, Action<object?, T?> onChanged, Action<object?, T?>? onChanging, Func<T?>? getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Creates a helper that raises an owner's change notifications through static callbacks, reading its initial value from a factory. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`object`](https://learn.microsoft.com/dotnet/api/system.object) `owner`: The object passed to both callbacks; [`Action<object?, T?>`](https://learn.microsoft.com/dotnet/api/system.action-2) `onChanged`: The callback run after each new value is stored; [`Action<object?, T?>?`](https://learn.microsoft.com/dotnet/api/system.action-2) `onChanging`: The callback run before each new value is stored, or null for none; [`Func<T?>?`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the source produces one; null returns the default value; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | [`ObservableAsPropertyHelper<T>`](properties.md): The helper. |
| `static Create(IObservable<T?> observable, object owner, Action<object?, T?> onChanged, Action<object?, T?>? onChanging, T? initialValue, bool deferSubscription, ISequencer? scheduler)` | Creates a helper that raises an owner's change notifications through static callbacks. | [`IObservable<T?>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `observable`: The observable the property follows; [`object`](https://learn.microsoft.com/dotnet/api/system.object) `owner`: The object passed to both callbacks; [`Action<object?, T?>`](https://learn.microsoft.com/dotnet/api/system.action-2) `onChanged`: The callback run after each new value is stored; [`Action<object?, T?>?`](https://learn.microsoft.com/dotnet/api/system.action-2) `onChanging`: The callback run before each new value is stored, or null for none; `T?` `initialValue`: The value the property holds before the source produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of `Value` before subscribing; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | [`ObservableAsPropertyHelper<T>`](properties.md): The helper. |
| `static Default()` | Creates a helper that holds the default value and never changes. | None. | [`ObservableAsPropertyHelper<T>`](properties.md): The helper. |
| `static Default(T? initialValue)` | Creates a helper that holds one value and never changes. | `T?` `initialValue`: The value the property holds | [`ObservableAsPropertyHelper<T>`](properties.md): The helper. |
| `static Default(T? initialValue, ISequencer? scheduler)` | Creates a helper that holds one value and never changes. | `T?` `initialValue`: The value the property holds; `ISequencer?` `scheduler`: The scheduler the callbacks run on, or null to run them on the producing thread | [`ObservableAsPropertyHelper<T>`](properties.md): The helper. |
| `Dispose()` | Stops following the observable. The property keeps its last value. | None. | — |
...
| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property)` | Backs the named read-only property with the observable's latest value. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)` | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result)` | Backs the named read-only property with the observable's latest value and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue)` | Backs the named read-only property with the observable's latest value, with an initial value factory. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, TRet initialValue)` | Backs the named read-only property with the observable's latest value, with an initial value. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; `TRet` `initialValue`: The value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue)` | Backs the named read-only property with the observable's latest value, with an initial value factory and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, TRet initialValue, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; `TRet` `initialValue`: The value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, TRet initialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value and optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, TRet initialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, Func<TRet> getInitialValue, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, TRet initialValue, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; `TRet` `initialValue`: The value the property holds before the observable produces one; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property, as a constant such as `nameof(Property)`; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, Func<TRet> getInitialValue, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, Func<TRet> getInitialValue, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, TRet initialValue, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; `TRet` `initialValue`: The value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, TRet initialValue, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value and optionally deferred subscription. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue, bool deferSubscription, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value and optionally deferred subscription and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, TRet initialValue, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToProperty<TObj, TRet>(TObj source, Func<TObj, TRet> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue, bool deferSubscription, ISequencer? scheduler, string propertyExpression = "", string callerFilePath = "", int callerLineNumber = 0)` | Backs the selected read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Func<TObj, TRet>`](https://learn.microsoft.com/dotnet/api/system.func-2) `property`: A lambda of the form `x => x.Property` that names the property; the generator reads it when you build, and nothing calls it; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `propertyExpression`: The caller argument expression for `property`. Auto-populated by the compiler; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `callerFilePath`: The source file path of the caller. Auto-populated by the compiler; [`int`](https://learn.microsoft.com/dotnet/api/system.int32) `callerLineNumber`: The source line number of the caller. Auto-populated by the compiler | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
...
Types: `ReactiveUI.Binding.BindingTypeConverter<TFrom, TTo>`, `ReactiveUI.Binding.BindingTypeConverterDispatch`, `ReactiveUI.Binding.Fallback.TwoWayConverterPair<TSourceProp, TTargetProp>`, `ReactiveUI.Binding.Fallback.TwoWayConverters`, `ReactiveUI.Binding.IBindingTypeConverter`, `ReactiveUI.Binding.IBindingTypeConverter<TFrom, TTo>`, `ReactiveUI.Binding.ISetMethodBindingConverter`.
...
| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `static class BindingTypeConverterDispatch` | Dispatches conversions using a type-only fast-path, avoiding reflection. | None. | — |

**Methods**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `TryConvert(IBindingTypeConverter converter, object? from, Type toType, object? conversionHint, out object? result)` | Attempts conversion via the converter's type-only metadata and its object shim. | [`IBindingTypeConverter`](converters.md) `converter`: The converter; [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `from`: The source value; [`Type`](https://learn.microsoft.com/dotnet/api/system.type) `toType`: The target type requested by the caller; [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `conversionHint`: Implementation-defined hint; out [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `result`: The converted result | [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean): `true` if conversion succeeded; otherwise `false`. |
| `TryConvertAny(object? converter, Type fromType, object? from, Type toType, object? conversionHint, out object? result)` | Unified dispatch method that handles both typed and fallback converters. | [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `converter`: The converter (either [`IBindingTypeConverter`](converters.md) or [`IBindingFallbackConverter`](converters.md)); [`Type`](https://learn.microsoft.com/dotnet/api/system.type) `fromType`: The source runtime type; [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `from`: The source value; [`Type`](https://learn.microsoft.com/dotnet/api/system.type) `toType`: The target type; [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `conversionHint`: Implementation-defined hint; out [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `result`: The converted result | [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean): `true` if conversion succeeded; otherwise, `false`. |
| `TryConvertFallback(IBindingFallbackConverter converter, Type fromType, object from, Type toType, object? conversionHint, out object? result)` | Attempts conversion using a fallback converter. | [`IBindingFallbackConverter`](converters.md) `converter`: The fallback converter; [`Type`](https://learn.microsoft.com/dotnet/api/system.type) `fromType`: The source runtime type; [`object`](https://learn.microsoft.com/dotnet/api/system.object) `from`: The source value (guaranteed non-null by caller); [`Type`](https://learn.microsoft.com/dotnet/api/system.type) `toType`: The target type; [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `conversionHint`: Implementation-defined hint; out [`object?`](https://learn.microsoft.com/dotnet/api/system.object) `result`: The converted result | [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean): `true` if conversion succeeded; otherwise, `false`. |
...
| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `SetService(ConverterService service)` | Replaces the converter service in use. | [`ConverterService`](converters.md) `service`: The converter service to use | — |
...
Types: `ReactiveUI.Binding.Observables.AppliedChangeObservable`, `ReactiveUI.Binding.Observables.CallbackPropertyObservable<TSource, TValue>`, `ReactiveUI.Binding.Observables.CombineLatestObservable`, `ReactiveUI.Binding.Observables.DeferredPropertyObservable<TSource, TValue>`, `ReactiveUI.Binding.Observables.EventObservable<T>`, `ReactiveUI.Binding.Observables.NotifyPropertyChangedObservable`, `ReactiveUI.Binding.Observables.PropertyChangingObservable<T>`, `ReactiveUI.Binding.Observables.PropertyObservable<T>`, `ReactiveUI.Binding.Observables.UnchangingPropertyObservable<T>`.
...
#### `CallbackPropertyObservable<TSource, TValue>`

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `sealed class CallbackPropertyObservable<TSource, TValue>` | Observes a property through a platform's own change callback: the value on subscription, then again each time the callback fires. | `TSource`: The type that declares the property; `TValue`: The type of the property value | — |

**Constructors**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `CallbackPropertyObservable(TSource source, Func<TSource, Action, IDisposable> subscribe, Func<TSource, TValue> getter, bool distinct)` | Initializes a new instance of the [`CallbackPropertyObservable<TSource, TValue>`](mechanisms.md) class. | `TSource` `source`: The object the property is read from; [`Func<TSource, Action, IDisposable>`](https://learn.microsoft.com/dotnet/api/system.func-3) `subscribe`: Attaches a callback to the platform's notification and returns what detaches it; [`Func<TSource, TValue>`](https://learn.microsoft.com/dotnet/api/system.func-2) `getter`: Reads the property from the source; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `distinct`: Whether a value equal to the last one delivered is suppressed | — |

**Methods**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `Subscribe(IObserver<TValue> observer)` | Notifies the provider that an observer is to receive notifications. | [`IObserver<TValue>`](https://learn.microsoft.com/dotnet/api/system.iobserver-1) `observer`: The object that is to receive notifications | [`IDisposable`](https://learn.microsoft.com/dotnet/api/system.idisposable): A reference to an interface that allows observers to stop receiving notifications before the provider has finished sending them. |
...
#### `DeferredPropertyObservable<TSource, TValue>`

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `sealed class DeferredPropertyObservable<TSource, TValue>` | Observes a property that has no change notification by reading it when a subscriber arrives: its value at that moment, once, and then silence. | `TSource`: The type that declares the property; `TValue`: The type of the property value | — |

**Constructors**

| Declaration | Description | Parameters | Returns |
| --- | --- | --- | --- |
| `DeferredPropertyObservable(TSource source, Func<TSource, TValue> getter)` | Initializes a new instance of the [`DeferredPropertyObservable<TSource, TValue>`](mechanisms.md) class. | `TSource` `source`: The object the property is read from; [`Func<TSource, TValue>`](https://learn.microsoft.com/dotnet/api/system.func-2) `getter`: Reads the property from the source | — |
...
| `MarkAsInitialized()` | Marks ReactiveUI.Binding as initialized. Called by `BuildApp`. | None. | — |
| `ResetForTesting()` | Resets the initialization state for testing purposes only. | None. | — |
...
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property)` | Backs the selected read-only property with the observable's latest value, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property)` | Backs the named read-only property with the observable's latest value, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result)` | Backs the selected read-only property with the observable's latest value and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, Func<TRet> getInitialValue)` | Backs the selected read-only property with the observable's latest value, with an initial value factory, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, TRet initialValue)` | Backs the selected read-only property with the observable's latest value, with an initial value, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; `TRet` `initialValue`: The value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result)` | Backs the named read-only property with the observable's latest value and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue)` | Backs the named read-only property with the observable's latest value, with an initial value factory, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, TRet initialValue)` | Backs the named read-only property with the observable's latest value, with an initial value, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; `TRet` `initialValue`: The value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue)` | Backs the selected read-only property with the observable's latest value, with an initial value and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, Func<TRet> getInitialValue, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, TRet initialValue, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; `TRet` `initialValue`: The value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, TRet initialValue, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with an initial value and optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue)` | Backs the named read-only property with the observable's latest value, with an initial value factory and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, TRet initialValue, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; `TRet` `initialValue`: The value the property holds before the observable produces one; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, TRet initialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value and optionally deferred subscription, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue, bool deferSubscription)` | Backs the selected read-only property with the observable's latest value, with an initial value and optionally deferred subscription and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, TRet initialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription)` | Backs the named read-only property with the observable's latest value, with an initial value factory and optionally deferred subscription and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, TRet initialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, Expression<Func<TObj, TRet>> property, out ObservableAsPropertyHelper<TRet> result, TRet initialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the selected read-only property with the observable's latest value, with an initial value, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`Expression<Func<TObj, TRet>>`](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expression-1) `property`: A selector of the form `x => x.Property` that names the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; `TRet` `initialValue`: The value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
| `IObservable<TRet>.ToPropertyUnsafe<TObj, TRet>(TObj source, string property, out ObservableAsPropertyHelper<TRet> result, Func<TRet> getInitialValue, bool deferSubscription, ISequencer? scheduler)` | Backs the named read-only property with the observable's latest value, with an initial value factory, optionally deferred subscription and a scheduler for its change notifications and also returns it through an out parameter, resolving the property and its notifications by reflection. | `TObj : class`: The type of the object that declares the property; `TRet`: The type of the property value; [`IObservable<TRet>`](https://learn.microsoft.com/dotnet/api/system.iobservable-1) `target` (receiver): The observable whose values the property takes; `TObj` `source`: The object that declares the property and raises its change notifications; [`string`](https://learn.microsoft.com/dotnet/api/system.string) `property`: The name of the property; out [`ObservableAsPropertyHelper<TRet>`](properties.md) `result`: Receives the helper, so it can be assigned to a field inside an expression; [`Func<TRet>`](https://learn.microsoft.com/dotnet/api/system.func-1) `getInitialValue`: Returns the value the property holds before the observable produces one; [`bool`](https://learn.microsoft.com/dotnet/api/system.boolean) `deferSubscription`: Whether to wait for the first read of the property's value before subscribing; `ISequencer?` `scheduler`: The scheduler change notifications are raised on, or null to raise them on the producing thread | [`ObservableAsPropertyHelper<TRet>`](properties.md): The helper that holds the property's current value. |
