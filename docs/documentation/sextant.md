...
> **Migration Note**: Coming from a legacy Xamarin.Forms codebase? See the [Xamarin to MAUI Migration Guide](reactiveui/upgrading/xamarin-to-maui.md).
...
- [MAUI Installation](reactiveui/getting-started/installation/maui.md)
- [Avalonia Installation](reactiveui/getting-started/installation/avalonia.md)
- [ReactiveUI Routing](reactiveui/handbook/routing.md)
- [Sample Applications](resources/samples.md)

## Related Topics

- [Routing](reactiveui/handbook/routing.md)
- [Commands](reactiveui/handbook/commands/index.md)
- [View Location](reactiveui/handbook/view-location/index.md)
- [MAUI Plugins Popup](maui-plugins-popup.md)
