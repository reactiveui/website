...
UserError were replaced by a much more generic mechanism called [Interactions](../handbook/interactions/index.md).
...
We decided to recommend [DynamicData](../handbook/collections.md) as many of the maintainers were already using that library.
