...
`InitializeOAPH()` method. The [ReactiveUI.Binding migration guide](../reactiveui/upgrading/reactiveui-binding-migration.md#reactiveuisourcegenerators)
...
- [Source Generators Documentation](../reactiveui/handbook/view-models/boilerplate-code.md)
- [Guidelines](../reactiveui/guidelines/index.md)
