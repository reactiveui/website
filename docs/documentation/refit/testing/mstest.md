...
[Run the complete MSTest project](https://github.com/reactiveui/refit/tree/main/src/examples/Documentation/TestingFrameworks/MSTest).

This page shows how to test a Refit client with MSTest and `Refit.Testing`. Each test solves one problem,
named in the comment above it.
The same tests exist for [xUnit](xunit.md), [NUnit](nunit.md) and [TUnit](tunit.md). Only the test attributes and assert calls change.
...
```bash
dotnet test examples/Documentation/TestingFrameworks/MSTest/MSTestTests.csproj
```
...
[`Person.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/Person.cs):
...
[`IPeopleApi.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/IPeopleApi.cs):
...
[`PersonJsonContext.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/PersonJsonContext.cs):
...
[`TestSettings.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/TestSettings.cs):
...
The tests are in [`GettingStartedTests.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/GettingStartedTests.cs).
...
The tests are in [`ErrorHandlingTests.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/ErrorHandlingTests.cs).
...
The tests are in [`NetworkConditionsTests.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/NetworkConditionsTests.cs).
...
The tests are in [`StreamingTests.cs`](https://github.com/reactiveui/refit/blob/main/src/examples/Documentation/TestingFrameworks/MSTest/StreamingTests.cs).
