...
`[ObservableAsProperty]` will generate a property with a ObservableAsPropertyHelper backing field. Any initializers will be passed through as a default value.
