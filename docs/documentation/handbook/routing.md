...
Override the default `IViewLocator` implementation to avoid having to manually register views. In the bootstrapping stage of your routing, register your view locator using `AppLocator.CurrentMutable.RegisterLazySingleton`. See [View Location](view-location/index.md) for details.
