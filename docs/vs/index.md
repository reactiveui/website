...
|---------|:--:|:--:|:--:|:--:|:--:|:--:|
| [ReactiveUI](https://github.com/reactiveui/ReactiveUI) | First-class (Rx-based) | `IScreen` + `RoutingState`, optional [Sextant](../documentation/sextant.md) | Splat (built-in) + adapters for Autofac, DryIoc, MSDI, Ninject, SimpleInjector | `ReactiveCommand<TParam, TResult>` (async-aware, exposes `IsExecuting`, `ThrownExceptions`, `CanExecute`) | [`ReactiveUI.SourceGenerators`](https://github.com/reactiveui/ReactiveUI.SourceGenerators) (`[Reactive]`, `[ReactiveCommand]`, `[IViewFor]`), and [ReactiveUI.Binding](../documentation/binding/index.md) (`[ObservableAsProperty]`, bindings) | Yes |
