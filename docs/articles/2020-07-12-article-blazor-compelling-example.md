...
The ReactiveUI website Getting Started section links a [Compelling Example](../documentation/reactiveui/getting-started/compelling-example.md), a simple Nuget browser that you can build very quickly with copypasta.  
