...
See [the PR for a sample app](https://github.com/reactiveui/ReactiveUI/pull/724), and check out the [documentation on Routing](../documentation/reactiveui/handbook/routing.md) for more information on how it works.
